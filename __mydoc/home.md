...
For more discussion about the available features, see {{site.data.urls.mydoc_supported_features.link}}.

## Getting started

To get started, see these three topics:

1. {{site.data.urls.mydoc_getting_started.link}}
2. {{site.data.urls.mydoc_configuration_settings.link}}
3. {{site.data.urls.mydoc_adding_new_projects.link}}
